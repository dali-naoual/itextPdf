...
//****************add to page
    ...
    //treams---------------------------------------------------------------------------
    public void TeamsPdf() throws FileNotFoundException, MalformedURLException {
        String imgSource="images\\bontaz.png";
        ImageData data= ImageDataFactory.create(imgSource);
        Image image1=new Image(data);
        image1.scaleToFit(90f, 60f);
        String path="C:\\pdf\\Teams.pdf";
        PdfWriter pdfWriter=new PdfWriter(path);
        Rectangle page=new Rectangle(600,1200);
        PdfDocument pdfdocument=new PdfDocument(pdfWriter);
        ...
        Table table8= new Table(UnitValue.createPercentArray(new float[]{5,5,5,5,5,5})).setMarginTop(5).setMarginLeft(-30).setMarginRight(-30).setWidth(588);
        table8.setWidth(UnitValue.createPercentValue(100));
        table8.setFixedLayout();
        Cell cell8_11=new Cell(1,6).setBackgroundColor(myColor)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("PRESENCE CHECK LIST")
                        .setFontColor(ColorConstants.WHITE)
                        .setBold());

        Cell cell8_12_=new Cell(2,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("").setFontColor(myColor)
                        .setBold());

        Cell cell8_12=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Meeting :").setFontColor(myColor)
                        .setBold());
        Cell cell8_13=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Containment").setFontColor(myColor)
                        .setBold());
        Cell cell8_14=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Analyse").setFontColor(myColor)
                        .setBold());

        Cell cell8_21=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Analyse").setFontColor(myColor) .setBold());
        Cell cell8_22=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER).setBackgroundColor(colorHeader)
                .add(new Paragraph("Closure").setFontColor(myColor) .setBold());

        Cell cell8_31=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER).setBackgroundColor(colorHeader)
                .add(new Paragraph("Date : ").setFontColor(myColor) .setBold());

        Cell cell8_32=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Containment").setFontColor(myColor)
                        );
        Cell cell8_33=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Analyse").setFontColor(myColor)
                        );

        Cell cell8_34=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Analyse").setFontColor(myColor));
        Cell cell8_35=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Closure").setFontColor(myColor));


        Cell cell8_41=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Name").setFontColor(myColor)
                        .setBold());

        Cell cell8_42=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Function ").setFontColor(myColor)
                        .setBold());
        Cell cell8_43=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Sign").setFontColor(myColor)
                        .setBold());
        Cell cell8_44=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Sign").setFontColor(myColor)
                        .setBold());
        ...
        Cell cell8_45=new Cell(1,1).setBackgroundColor(colorHeader)
                .setTextAlignment(TextAlignment.CENTER)
                .add(new Paragraph("Sign").setFontColor(myColor) .setBold());
        Cell cell8_46=new Cell(1,1)
                .setTextAlignment(TextAlignment.CENTER).setBackgroundColor(colorHeader)
                .add(new Paragraph("Sign").setFontColor(myColor) .setBold());
        ...
        table8.addCell(cell8_11);
        table8.addCell(cell8_12_);
        table8.addCell(cell8_12);
        table8.addCell(cell8_13);
        table8.addCell(cell8_14);
        table8.addCell(cell8_21);
        table8.addCell(cell8_22);
        table8.addCell(cell8_31);
        table8.addCell(cell8_32);
        table8.addCell(cell8_33);
        table8.addCell(cell8_34);
        table8.addCell(cell8_35);
        table8.addCell(cell8_41);
        table8.addCell(cell8_42);
        table8.addCell(cell8_43);
        table8.addCell(cell8_44);
